...
Drop-in replacement for CogneeMemoryService. Same interface, no vendor
dependency. Uses PostgreSQL for persistence and OpenAI embeddings for
semantic search.
...
class MemoryService:
    ...
    Replaces CogneeMemoryService with the same interface:
